        ...
        >
          ...
          >
            <div class="px-4 py-3 text-sm border-b border-default">
              ...
              >
              <span class="block text-body truncate">welcome to shopverse</span>
            </div>
            <ul
        ...
        >
          ...
          >
            ...
            <li>
              <NuxtLink
                to="/cart"
                class="flex py-2 px-3 text-heading rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0 md:dark:hover:bg-transparent"
              >
                <Icon
                  name="uil:shopping-cart"
                  class="w-6 h-6 text-fg-brand"
                  aria-hidden="true"
                />
                Cart</NuxtLink
              >
